...
#define OBJSCHEMA_12(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12)   "{\"type\":\"object\",\"properties\":{" p1 "," p2 ", " p3 ", " p4 ", " p5 ", " p6 ", " p7 ", " p8 ", " p9 ", " p10 ", " p11 ", " p12 "}}"
#define OBJSCHEMA_16(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16)   "{\"type\":\"object\",\"properties\":{" p1 "," p2 ", " p3 ", " p4 ", " p5 ", " p6 ", " p7 ", " p8 ", " p9 ", " p10 ", " p11 ", " p12 ", " p13 ", " p14 ", " p15 ", " p16 "}}"
...
inline bool parsePayload(const std::string &payload, pbnjson::JValue &object, const std::string &schema, int *error)
{
	...
	if (!parser.parse(payload, parseSchema))
	{
		if (strstr(parser.getError(), "parse error"))
		{
